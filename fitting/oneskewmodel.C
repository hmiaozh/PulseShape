...
//   TFile* f1 = TFile::Open("/afs/cern.ch/work/h/hum/public/CMSSW_8_0_8/src/PulseShapes/thegraphs2.root");
   ...
   TProfile *ro = (TProfile*)f1->Get("prof_57");  
...
//   fr[1]=9.0;
   ...
   pllo[0]=0.05; pllo[1]=1.0; pllo[2]=1.0; pllo[3]=0.05; pllo[4]=-1.0;
   plhi[0]=1.0; plhi[1]=9.0; plhi[2]=1.0; plhi[3]=1.0; plhi[4]=1.0;
